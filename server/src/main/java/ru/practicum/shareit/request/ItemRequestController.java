...
public class ItemRequestController {
    ...
    @PostMapping
    public ResponseEntity<ItemRequestSendDto> postRequest(@RequestHeader("X-Sharer-User-Id") @NotNull Long requesterId,
    ...
    public ResponseEntity<ItemRequestSendDto> getRequestById(@RequestHeader("X-Sharer-User-Id") @NotNull Long requesterId,
                                                             @PathVariable("requestId") Long requestId) {
        return new ResponseEntity<>(modelToSendDto(service.getById(requesterId, requestId)), HttpStatus.OK);
    }

    @GetMapping
    public ResponseEntity<List<ItemRequestSendDto>> getUserRequests(@RequestHeader("X-Sharer-User-Id") @NotNull Long requesterId) {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<ItemRequestSendDto>> getAllPageable(@RequestHeader("X-Sharer-User-Id")
